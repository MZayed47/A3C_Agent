...
from enviroments import create_atari_env
...
optimizer = optimize.SharedAdam(shared_model.parameters(), lr=params.lr) # the optimizer is also shared because it acts on the shared model
